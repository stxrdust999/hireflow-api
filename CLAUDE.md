...
| `job_listings` | Vagas (renomeada de `jobs` por conflito com fila interna do Laravel) |
...
> **Atenção:** A tabela de vagas se chama `job_listings`, não `jobs`. O Laravel usa `jobs` internamente para filas.
